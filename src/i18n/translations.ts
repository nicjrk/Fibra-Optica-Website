  ...
  de: {
    translation: {
      ...
      services: {
        ...
        subtitle: 'Professionelle Lösungen für Ihre Bedürfnisse',
        fiber: {
  ...
  ro: {
    translation: {
      ...
      services: {
        ...
        subtitle: 'Soluții profesionale pentru nevoile dumneavoastră',
        fiber: {
      ...
      contact: {
        ...
        form: {
          ...
          message: 'Mesaj',
          submit: 'Trimite',
          success: 'Vă mulțumim pentru mesaj. Vă vom contacta în curând.',
